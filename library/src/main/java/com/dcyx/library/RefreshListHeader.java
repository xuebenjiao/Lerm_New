...
public class RefreshListHeader extends LinearLayout {
    ...
    private TextView mHintLastTextView;
    ...
    private void initView(Context context) {
        ...
        mHintLastTextView = (TextView) findViewById(R.id.xlistview_header_hint_last_textview);
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                if(lastUpdateTime!=null&&!lastUpdateTime.equals("")){
                    mHintLastTextView.setVisibility(View.VISIBLE);
                    mHintLastTextView.setText("上次更新时间："+lastUpdateTime);
                }
            ...
            case STATE_REFRESHING:
                mHintLastTextView.setVisibility(INVISIBLE);
